...
async function restoreOptions() {
  ...
  document.getElementById('check-venv').checked = options.checks.venv;
  document.getElementById('check-trace').checked = options.checks.trace;
...
async function saveOptions() {
  const options = {
    checks: {
      ...
      venv: document.getElementById('check-venv').checked,
      trace: document.getElementById('check-trace').checked
    },
